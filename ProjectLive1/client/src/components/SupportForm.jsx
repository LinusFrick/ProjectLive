...
export default function () {
    ...
    return !click ?
        <form className="supportForm">
            ...
            <input className="inputEmail" placeholder={'yourEmail@email.com'} type="email" onChange={(e) => setEmail(e.target.value)}/>
            <input className="ticketButton" type="submit" value={"Send"} onClick={handleClick}/>;
